                                ...
                                <tbody>
                                    @foreach ($userlists as $userlist)
                                        <tr>
                                            ...
                                            <td>{{$userlist->role}}</td>
                                            <td>
                                                <div class="custom-control custom-switch custom-control-inline show-userlist-update" data-id="{{$userlist->id}}" data-user_show="{{$userlist->user_show}}">
                                                <input type="checkbox" class="custom-control-input" id="customSwitchshow{{$userlist->id}}" @if ($userlist->user_show == 'on') checked @endif class="status-checked"  @if($userlist->id == 1 || Auth::user()->rolefunction->users_write != 'on' || Auth::user()->status == '') disabled @endif>
                                                <label class="custom-control-label" for="customSwitchshow{{$userlist->id}}"></label>
                                                </div>
                                            </td>
                                            <td>
