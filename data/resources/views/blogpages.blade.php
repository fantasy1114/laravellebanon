...
<body> 
            ...
            <div class="content-detached">
                <div class="content-body">
                    @foreach ($blogs as $blog)
                        <section id="blog{{$blog->id}}" class="list-view">
                            <div class="card ecommerce-card">
                                <div class="item-img text-center">
                                    <a>
                                        <img class="img-fluid card-img-top" src="{{ $blog->photo }}" alt="img-placeholder">
                                    </a>
                                </div>
                                <div class="card-body">
                                    <h2>
    ...
    {{-- <div style="height: 50px;"><span class="float-right">{!! $blogs->links() !!}</span></div> --}}
    <!-- END: Content-->
