...
<html lang="en">
  <head>
    ...
    <!--====== Favicon Icon ======-->
    <link rel="shortcut icon" href="./dashboard/img/2.png" type="image/png">
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="./dashboard/css/bootstrap.min.css">
    <link rel="stylesheet" href="./dashboard/css/animate.css">
    <link rel="stylesheet" href="./dashboard/css/LineIcons.css">
    ...
    <link rel="stylesheet" href="./dashboard/css/nivo-lightbox.css">
  ...
  <body>
    ...
    <header id="home" class="hero-area">    
      ...
      <nav class="navbar navbar-expand-md bg-inverse fixed-top scrolling-navbar">
        <div class="container">
          <a href="index.html" class="navbar-brand"><img src="./dashboard/img/logo.png" alt=""></a>       
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav mr-auto w-100 justify-content-end">
              ...
              <li class="nav-item">
                <a class="btn btn-singin" href="/auth/login-v1/">Login</a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="container">      
        <div class="row space-100">
          ...
          <div class="col-lg-6 col-md-12 col-xs-12 p-0">
            <div class="intro-img">
              <img src="./dashboard/img/intro.png" alt="">
            </div>            
          </div>
        </div> 
      </div>             
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-12 pl-0 pt-70 pr-5">
            <div class="business-item-img">
              <img src="./dashboard/img/business/business-img.png" class="img-fluid" alt="">
            </div>
          </div>
          <!-- End Col -->
          <!-- Start Col -->
            ...
            <div class="showcase-slider owl-carousel">
              <div class="item">
                <div class="screenshot-thumb">
                  <img src="./dashboard/img/showcase/01.jpg" class="img-fluid" alt="" />
              ...
              <div class="item">
                <div class="screenshot-thumb">
                  <img src="./dashboard/img/showcase/02.jpg" class="img-fluid" alt="" />
                  <div class="hover-content text-center">
                    <div class="fancy-table">
                      <div class="table-cell">
                        <div class="single-text">
              ...
              <div class="item">
                <div class="screenshot-thumb">
                  <img src="./dashboard/img/showcase/03.jpg" class="img-fluid" alt="" />
                  <div class="hover-content text-center">
                    <div class="fancy-table">
                      <div class="table-cell">
                        <div class="single-text">
              ...
              <div class="item">
                <div class="screenshot-thumb">
                  <img src="./dashboard/img/showcase/04.jpg" class="img-fluid" alt="" />
                  <div class="hover-content text-center">
                    <div class="fancy-table">
                      <div class="table-cell">
                        <div class="single-text">
              ...
              <div class="item">
                <div class="screenshot-thumb">
                  <img src="./dashboard/img/showcase/05.jpg" class="img-fluid" alt="" />
                  <div class="hover-content text-center">
                    <div class="fancy-table">
                      <div class="table-cell">
                        <div class="single-text">
              ...
              <div class="item">
                <div class="testimonial-item">
                  ...
                  <div class="client-thumb">
                    <img src="./dashboard/img/testimonial/01.png" alt="">
                  </div>
                </div>
              </div>
              <div class="item">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <div class="team-thumb">
                <img src="./dashboard/img/team/01.jpg" class="img-fluid" alt="">
              </div>
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <div class="team-thumb">
                <img src="./dashboard/img/team/02.jpg" class="img-fluid" alt="">
              </div>
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <div class="team-thumb">
                <img src="./dashboard/img/team/03.jpg" class="img-fluid" alt="">
              </div>
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <div class="team-thumb">
                <img src="./dashboard/img/team/04.jpg" class="img-fluid" alt="">
              </div>
        ...
        <div class="row">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="./dashboard/img/blog/01.jpg" class="img-fluid" alt="">
                </a>             
              </div>
          ...
          <div class="col-lg-4 col-md-6 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="./dashboard/img/blog/02.jpg" class="img-fluid" alt="">
                </a>             
              </div>
              <div class="blog-item-text"> 
          ...
          <div class="col-lg-4 col-md-6 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="./dashboard/img/blog/03.jpg" class="img-fluid" alt="">
                </a>             
              </div>
              <div class="blog-item-text"> 
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-12">
            <div class="contact-img">
              <img src="./dashboard/img/contact/01.png" class="img-fluid" alt="">
            </div>
          </div>
          <!-- End Col -->
          <!-- Start Col -->
          ...
          <!-- Start Col -->
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-mb-12">
              ...
              <div class="footer-logo">
               <img src="./dashboard/img/footer-logo.png" alt="">
              </div>
            </div>
             <!-- End Col -->
              <!-- Start Col -->
    ...
    <script src="./dashboard/js/scrolling-nav.js"></script>    
    <script src="./dashboard/js/jquery.easing.min.js"></script>     
    <script src="./dashboard/js/nivo-lightbox.js"></script>     
    <script src="./dashboard/js/jquery.magnific-popup.min.js"></script>     
    <script src="./dashboard/js/form-validator.min.js"></script>
    <script src="./dashboard/js/contact-form-script.js"></script>   
    <script src="./dashboard/js/main.js"></script>
    
  </body>
</html><?php /**PATH D:\Lebanon\phpframe\resources\views//dashboard/dashboard.blade.php ENDPATH**/ ?>