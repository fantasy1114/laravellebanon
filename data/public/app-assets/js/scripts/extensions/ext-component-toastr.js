...
$(function () {
  ...
  var isRtl = $('html').attr('data-textdirection') === 'rtl',
    ...
    typecompanyupdateerror = $('#type-company-update-error'),
  ...
  typeError.on('click', function () {
    toastr['error']('👋 You need to delete that category.', 'Error!', {
      closeButton: true,
      tapToDismiss: false,
      rtl: isRtl
    });
  });
  typecategoryError.on('click', function () {
    toastr['error']('👋 You need to delete that item.', 'Error!', {
      closeButton: true,
      tapToDismiss: false,
      rtl: isRtl
    });
  });
  typecompanyupdateerror.on('click', function () {
    toastr['error']('👋 The Company already exists.', 'Error!', {
      closeButton: true,
      tapToDismiss: false,
      rtl: isRtl
    });
  });
  typecategoryalreadyerror.on('click', function () {
    toastr['error']('👋 The category already exists.', 'Error!', {
      closeButton: true,
      tapToDismiss: false,
      rtl: isRtl
    });
