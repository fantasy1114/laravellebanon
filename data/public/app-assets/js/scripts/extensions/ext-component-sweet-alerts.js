...
$(function () {
  ...
  var confirmText = $('.userlist-delete');
  ...
  if (confirmText.length) {
   ...
   // company Text
   if (deletecompanydata.length) {
    deletecompanydata.on('click', function () {
          ...
          $.ajax({
            ...
            success: function(data) {
                if(data['success']){
                    ...
                    $(".toast-company-error-message").click();
                }
            }
          });
        }
          ...
          $.ajax({
            ...
            success: function(data) {
                if(data['success']){
                    ...
                    $(".toast-category-error-message").click();
                }
            }
          });
        }
